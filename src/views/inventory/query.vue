  ...
  <section> 
    ...
    <el-form :inline="true" :model="formData" ref="queryForm">
      <el-row>
        ...
        <el-col :span="3">  
          <el-form-item>   
            <el-button type="primary" @click="handleDownloadExcel">导出已盘数据(excel)</el-button>
          </el-form-item>
        </el-col>
      </el-row>        
      <el-row>
        <el-col :span="13">              
          ...
          <el-form-item label="盘点商品">
            <el-input v-model="formData.itemId" placeholder="输入盘点商品"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="3">              
          <el-form-item>
        ...
        <el-col :span="3">  
          <el-form-item>   
            <el-button type="primary" @click="handleDownloadTxt">导出汇总数据(txt)</el-button>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
    ...
    <el-table
      ...
      <el-table-column prop="checkNo" label="盘点单号" width="120px">
      </el-table-column>
      <el-table-column prop="itemId" label="商品编码" width="80px">
      </el-table-column>
      <el-table-column prop="itemName" label="商品名称" width="350px" 
        show-overflow-tooltip
        sortable>
      </el-table-column>
      <el-table-column prop="produce" label="厂家" width="200px" 
        show-overflow-tooltip
        sortable>
      </el-table-column>
      <el-table-column prop="makeNo" label="批号" width="100px" 
        show-overflow-tooltip>
      </el-table-column>
      <el-table-column prop="checkQty" label="盘点数量" width="80px">
      </el-table-column>
      <el-table-column prop="actDate" label="盘点时间" width="160px">
      </el-table-column>
      <el-table-column prop="actorId" label="盘点人" width="150px">
      </el-table-column>
    </el-table>
...
import { fetchDetailList, downloadDetail, downloadTotal } from '@/api/inventory'
...
export default {
  ...
  computed: {
    isOnlyDiff: {
      get: function() {
        return this.formData.isFlag === 1
      },
      set: function(newValue) {
        this.formData.isFlag = newValue ? 1 : 0
      }
    },
    pages: {
      get: function() {
  ...
  methods: {
    ...
    handleDownloadExcel() {
      this.loading = true
      downloadDetail(this.formData)
        .then(response => {
          const link = document.createElement('a')
          link.href = process.env.BASE_API + response.data.data
    ...
    handleDownloadTxt() {
      this.loading = true
      downloadTotal(this.formData)
        .then(response => {
          var fileName = '盘点汇总数据.txt'
          if (response.headers.hasOwnProperty('content-disposition')) {
            fileName = response.headers['content-disposition'].match(/filename=(\S*)/)[1]
          }
